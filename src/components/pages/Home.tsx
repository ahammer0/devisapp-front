...
const Home = () => {
  return (
    <MainTemplate className="homeSection">
      ...
      <section>
        ...
        <p>
          ...
          importantes. Notre système de saisie de devis est conçu pour que vous
          puissiez obtenir le document en un <strong>temps record</strong>. Tout
          est optimisé pour que vous puissiez saisir vos devis tout en faisant
          votre rendez-vous client.
        </p>
      </section>
      <section>
        ...
        <p>
          ...
          , envoyez vos devis par e-mail ou dirrectement en courrier postal en
          un simple clic !
        </p>
      </section>
      <section className="homeSection__social">
        ...
        <article>
          <picture>
            <source
              ...
              media="(min-width:768px)"
            />
            <source srcSet="/images/pierre_macon_w100.webp" type="image/webp" />
            <img src="/images/pierre_macon.png" className="profile" />
          </picture>
          <blockquote>
            <p>
              Mes clients me valident mes devis tant que je suis enccore avec
              eux et je gagne du temps.
            </p>
            <p>
        ...
        <article>
          <picture>
            <source
              ...
              media="(min-width:768px)"
            />
            <source srcSet="/images/marc_elec_w100.webp" type="image/webp" />
            <img src="/images/marc_elec.png" className="profile" />
          </picture>
          <blockquote>
            <p>
              Je n' ai jamais eu autant de temps libre depuis que j' utilise
              appli chantier !
            </p>
            <p>
        ...
        <article>
          ...
          <blockquote>
            <p>
              Depuis que j' utilise appli chantier, j' ai le temps de faire plus
              de chantiers !
            </p>
            <p>
